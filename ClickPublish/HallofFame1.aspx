<%@ Page Title="Hall of Fame" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HallofFame1.aspx.cs" Inherits="ClickPublish.About" %>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableSortingAndPagingCallbacks="True">
    <Columns>
        <asp:BoundField DataField="fname" HeaderText="First Name" SortExpression="fname" HtmlEncode="False" />
        <asp:BoundField DataField="lname" HeaderText="Last Name" SortExpression="lname" HtmlEncode="False" />
